...
This repo specifically makes [cppcoro](https://github.com/lewissbaker/cppcoro) C++23 and CMake compatible. To inlcude this repo into your project just add this line into your `CMakeLists.txt` and edit the path to cppcoro.
```cmake
add_subdirectory('PATH_TO_CPPCORO')
```
